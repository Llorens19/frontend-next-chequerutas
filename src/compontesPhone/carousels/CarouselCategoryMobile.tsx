...
const CarouselCategoryMobile = ({ categories }: ICategories) => {
        ...
        <div className="carousel-wrapper overflow-hidden w-full">
          ...
          >
            {itemsStacked().map((stack, idx) => (
              <div
                key={idx}
                className="carousel-slide flex-shrink-0 w-full grid grid-cols-3 gap-2 p-2"
              >
                {stack.map((category: ICategory) => (
                  <div
                    key={category.idCategory}
                    className="p-4 bg-color1 rounded-3xl text-center relative cursor-pointer h-32 flex items-center justify-center"
                    style={{
                  ...
                  >
                    <div className="absolute inset-0 bg-black bg-opacity-40 rounded-3xl flex items-center justify-center p-2 hover:bg-opacity-60 transition">
