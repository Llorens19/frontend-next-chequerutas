...
const CardRouteMobile = ({ route }: ICardRouteInput) => {
  ...
  const [imageUser, setIimageUser] = useState(
    route.user?.imgUser || '/images/profile/perfil.jpg'
  );
  ...
  return (
    <>
      <div
        className="flex flex-col bg-color2 rounded-3xl overflow-hidden m-4 p-4 transition"
        onClick={detailRouteRedirect}
      >
        <div>
          <h3 className="text-2xl font-black text-center text-text1 mb-4">
            {route.title}
          </h3>
        </div>
        ...
        <div className="flex justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-2 " >
              ...
              <p className="text-sm text-text4 hover:scale-105 transition-transform cursor-pointer hover:underline" onClick={onClickLocation}>{route.location?.nLocation}</p>
            </div>
            ...
            <div className="flex items-center gap-2 "  >
              ...
              <p className="text-sm text-text4 hover:scale-105 transition-transform hover:underline cursor-pointer"  onClick={onClickCategory}>{route.category?.nameCategory}</p>
            </div>
        ...
        <div className="flex mt-4">
            <ul className="w-1/2">
              <li className="flex flex-col items-center">
                <div className="text-2xl font-black text-text2">
