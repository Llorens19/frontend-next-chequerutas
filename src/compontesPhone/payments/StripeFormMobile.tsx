...
const StripeFormMobile = ({
  ...
  return (
    <div className="flex flex-col h-fulljustify-center items-center h-screen bg-color4">
      <div className="w-full mx-auto bg-color1 py-16 p-4">
        ...
        <div className="w-full mx-auto flex flex-col gap-6">
          ...
          <div className="w-full">
            <label className="text-text3 ">Tarjeta de crédito</label>
            <CardElement
              options={{
                style: {
                  base: {
          ...
          <div className="w-full flex gap-4">
            <button
              onClick={onPay}
              disabled={!stripe}
              className="w-4/6 self-end bg-text1 text-color3 p-2 rounded-3xl border-2 border-text1 hover:bg-color1 hover:text-text1 transition duration-300 text-ms"
            >
      ...
      <div className="w-full flex justify-center items-center bg-color4 p-4">
...
export default StripeFormMobile;
