const MobileIcons = ({
  ...
  const premium_user = (
    ...
    >
      ...
      />
      <path
        d="M14 16L16 13H20L22 16L18 21.5L14 17Z"
        stroke={color}
        strokeWidth="2.5"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  if (icon === 'create_route') return create_route;
  if (icon === 'settings') return settings;
  if (icon === 'auth') return auth;
  if (icon === 'premium_user') return premium_user;
  if (icon === 'auth_user') return auth_user;
  if (icon === 'logged_user') return logged_user;
  if (icon === 'bell') return bell;
  if (icon === 'gallery') return gallery;
  if (icon === 'filters') return filters;
